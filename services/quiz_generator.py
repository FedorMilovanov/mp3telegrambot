...
ТЕХНИЧЕСКИЕ ТРЕБОВАНИЯ К ВАРИАНТАМ (вопрос с нарушением ОТБРАСЫВАЕТСЯ автоматикой):
- каждый вариант — содержательная ФРАЗА минимум из 2 значимых слов и минимум
  8 символов; однословные варианты («Монергизм») не проходят валидатор —
  разверни их («Монергизм: спасение совершает только Бог»);
- варианты сопоставимы по длине: самый короткий не короче ~40% медианного,
  правильный не длиннее ~2.4× медианного — иначе ответ выдаёт себя длиной;
- правильный вариант не должен быть заметно детальнее остальных.
