...
# Feed source duration into acquisition immediately. The later validated source
# duration remains a second independent guard before render/persistence use.
replace_once(
...
# Semantic fallback is disabled, so remove old ambient process-global bookkeeping
# instead of keeping a permanently-False compatibility seam.
replace_once(
...
# Update stale docs/logging around the now-strict single-model paths.
replace_once(
    "services/telegraph_pages.py",
...
# Fail startup if the removed browser provider ever reappears after migration.
replace_once(
...
print("REMAINING_AUDIT_HARDENING_APPLIED")
