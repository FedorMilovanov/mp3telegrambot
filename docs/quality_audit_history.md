...
The prompts now describe these as patterns rather than repeating exact bad output strings. Prompt-health leaky literal detection was expanded accordingly and current prompts report zero known leaks across main prompts and the deep audio prompt sample.
