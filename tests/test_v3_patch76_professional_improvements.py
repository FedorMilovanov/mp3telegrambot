...
def test_person_names_and_source_titles_share_canonical_display_names():
    assert canonical_person_name("Р. Ч. Спрол") == "Р. К. Спроул"
    assert canonical_author_name("R.C. Sproul") == "Р. К. Спроул"
    assert normalize_source_card_line("• R.C. Sproul, The Holiness of God") == "• **Святость Бога**, Р. К. Спроул (The Holiness of God, R.C. Sproul)."
