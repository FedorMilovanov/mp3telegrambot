...
from services.tts_weighted_smoke import WeightedTTSSmokeConfig
from tools.run_tts_weighted_smoke import _redacted_failure


def test_weighted_smoke_failure_redacts_every_local_path(tmp_path: Path) -> None:
