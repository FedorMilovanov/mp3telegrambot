...
from services import livedub_audio_quality_guard as quality
from services import project_runtime_hardening as hardening


def test_zero_exit_without_valid_output_becomes_failure(tmp_path, monkeypatch):
    ...
    quality._install_conversion_postcondition()
