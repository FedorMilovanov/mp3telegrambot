...
_COMMON_TYPO_REPLACEMENTS: tuple[tuple[str, str], ...] = (
    ...
    ("мучем за", "мучим за"),
    ("Мучем за", "Мучим за"),
    # R49: Пс. 2:10 по Синодальному — «Итак вразумитесь, цари». Модель процитировала
    # «уразумейте, цари» (уразумейте = «поймите», у Синодального стоит «вразумитесь»).
    # Якорим по «уразумейте, цари», чтобы не задеть легитимный императив «уразумейте».
    ("уразумейте, цари", "вразумитесь, цари"),
