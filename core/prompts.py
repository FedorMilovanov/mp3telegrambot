...
- Не пиши «в материале говорится», «в материале рассматривается», «материал показывает».
...
3. Нет ли редакторских фраз вида «автор показывает» / «материал рассматривает»?
...
Если разница между переводами банальна (например, «делающие» vs «practice») и не открывает новых богословских глубин — ПОЛНОСТЬЮ ПРОПУСТИ этот блок, не пиши его ради галочки. Если приводишь английский текст, обязательно давай русский смысловой перевод в скобках.
...
— «данный раздел показывает», «это свидетельствует», «это говорит нам»
— «почему это важно», «важно понять», «важно учитывать»
{THIRD_PERSON_BAN}
— «материал касается», «в этой секции», «данный блок»
— Квадратные скобки [ и ] — нигде, никогда.
