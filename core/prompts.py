...
Также запрещено: "Джон МакАртур открывает", "МакАртур показывает", "проповедник направляет внимание".
...
КРИТИЧЕСКИ ВАЖНО: Если разница между переводами банальна (например, «делающие» vs «practice») и не открывает новых богословских глубин — ПОЛНОСТЬЮ ПРОПУСТИ этот блок, не пиши его ради галочки. Если приводишь английский текст, обязательно давай русский смысловой перевод в скобках.
