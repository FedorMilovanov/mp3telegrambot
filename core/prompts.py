...
❌ ЗАПРЕЩЕНО: - **Джон Оуэн, «Умерщвление греха»...** — НЕ оборачивай в жирный
...
ПРАВИЛО ИМЁН ПРОПОВЕДНИКА:
Чередуй полное имя и фамилию.
- Первое упоминание: полное имя (Джон МакАртур).
- Далее: только фамилия (МакАртур).
- Не повторяй одну форму более 3 раз подряд.
