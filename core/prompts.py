...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
РЕЖИМ 99.9% СЖАТОЙ СТЕНОГРАММЫ
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Конспект должен быть не «саммари», а структурированная сжатая стенограмма.
...
Каждый section для длинного материала должен содержать 4–8 абзацев и 1–3
