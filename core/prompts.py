...
Начинай этот абзац НЕ с шаблонной метки «**В материале:**», а с самого имени проповедника
или с описания момента проповеди — например: «Вошер разворачивает это понятие когда...»
или «В кульминационной сцене свидетельства...» или «Этот смысловой пласт открывается
в эпизоде с...». Цель: органичный переход, а не технический ярлык.


Не выдумывай том и страницу. Осторожная ссылка лучше ложной точности.
Прямые цитаты из источников — ТОЛЬКО если помнишь точно.
Если сомневаешься — перефразируй: «Эдвардс настаивает, что...»
а не «Эдвардс пишет: "..."». Ложная точность хуже честной неточности.
...
Пиши органично: имя проповедника или описание момента как первое слово абзаца.
НЕ оборачивай весь абзац в **...** — это ломает рендеринг таймкодов.

❌ ЗАПРЕЩЕНО: **В материале:** **Вошер разворачивает это как...  ⏱** 10:45 **.**
✅ ПРАВИЛЬНО:  Вошер разворачивает это понятие в ключевой сцене... ⏱ **10:45**.
...
МакАртур цитирует «делающие беззаконие» и разворачивает именно это — не грехи по списку, а принципиальное нежелание подчиниться Богу. Именно это разоблачает религиозную активность без настоящего обращения.
...
Уровень B — ИЗВЕСТНАЯ ПОЗИЦИЯ:
  ...
  Формат: "X полезна здесь потому, что показывает..."
