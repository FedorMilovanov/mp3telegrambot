...
1. НЕ оборачивай строку с автором и названием в **жирный**.
   Автор — обычным текстом. Название — *курсивом*.
   Если есть русский перевод: - Автор, *«Русское название»* (*Original Title*)
   Если нет русского перевода: - Автор, *Original Title* (без ёлочек, только латиница)
   Точку в конце строки НЕ ставить.
...
3. КРИТИЧЕСКИ ВАЖНО — если НЕ уверен что книга переводилась на русский:
   ...
   ✅ ПРАВИЛЬНО: - Чарльз Сперджен, *Infant Salvation*
...
- Томас Уотсон, *«Учение о покаянии»* (*Thomas Watson, The Doctrine of Repentance*)
Пуританское руководство по природе подлинного покаяния — его составляющим и плодам.

❌ ЗАПРЕЩЕНО: - **Джон Оуэн, «Умерщвление греха»...** — НЕ оборачивай карточку в жирный
❌ ЗАПРЕЩЕНО: - **Чикагское заявление о безошибочности Писания (1978).** — один источник жирный, остальные нет
✅ ПРАВИЛЬНО:  - Джон Оуэн, *«Умерщвление греха»* (*John Owen, Of the Mortification of Sin*)
...
5. «Карта источников»: заголовки (автор+книга) — ОБЫЧНЫМ шрифтом, НЕ жирным.
   Название книги — *курсивом*. Описание — обычным текстом.
   ❌ ЗАПРЕЩЕНО: - **Джон Оуэн, «Умерщвление греха»...**
   ❌ ЗАПРЕЩЕНО: - **Чарльз Сперджен, *«Младенцы во славе»*...**
   ✅ ПРАВИЛЬНО:  - Джон Оуэн, *«Умерщвление греха»* (*John Owen, ...*)
   ...
   КАЖДАЯ карточка источника: автор и название — ОБЫЧНЫМ текстом. БЕЗ жирного.
   Точку в конце строки автор+название НЕ ставить.
