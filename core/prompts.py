...
КРИТИЧНО ДЛЯ RTL: если оригинальное слово написано справа налево (иврит, арабский), НЕ начинай абзац с него — ставь его ПОСЛЕ транслитерации или кириллического обозначения. Формат: **транслитерация** (**ивритское_слово**, евр.) — словарь: значение. Или: (*ʾĕnôš*, **אֱנוֹשׁ**, евр.) — HALOT (еврейский словарь ВЗ): ... Это предотвращает сбой выравнивания абзаца вправо в браузере.

КРИТИЧЕСКИ ВАЖНО — ФОРМАТИРОВАНИЕ «В материале:»:
Метка **В материале:** — это единственное жирное в этой строке. Весь ТЕКСТ ПОСЛЕ неё — обычный, не жирный.
НЕ оборачивай весь абзац «В материале:» в **...** — это ломает рендеринг таймкодов и делает текст нечитаемым.

❌ ЗАПРЕЩЕНО: **В материале:** **Сперджен разворачивает это как «утреннюю милость»... ⏱** 10:45 **.**
✅ ПРАВИЛЬНО:  **В материале:** Сперджен разворачивает это как «утреннюю милость»... ⏱ **10:45**.

Пример:
**ἀνομία** (*anomia*, греч.) — 1) беззаконие как нарушение закона; 2) состояние бунта против Божьего порядка.
...
**אֱנוֹשׁ** (*ʾĕnôš*, евр.) — человек в его хрупкости, смертности и слабости.
