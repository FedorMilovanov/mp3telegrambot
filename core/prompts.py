...
Это:
- речь автора, очищенная от мусора (оговорки, повторы без усиления, паузы),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
РЕЖИМ 99.9% ПОДРОБНОЙ ТРАНСКРИПЦИИ (БЕЗ СЖАТИЯ)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Конспект должен быть не «саммари», а подробная, развернутая стенограмма. Пиши МАКСИМАЛЬНО ДЛИННО. Не укорачивай фразы автора.
...
Каждый section ОБЯЗАН содержать минимум 5-10 абзацев и быть максимально длинным и 1–3
...
Это тоже режим сжатой стенограммы: сохраняй конкретные формулировки, примеры,
...
- давать не менее 3 абзацев для длинного ответа, если автор реально разворачивает мысль;
