...
- его сильные фразы — дословно, в кавычках если выделяешь жирным.
...
оформленных жирным **«в кавычках-ёлочках»**.
Это якоря — самые острые, поворотные или запоминающиеся слова.
Без них конспект превращается в пересказ.

Что брать дословно:
- ударные определения («Тюремщик умер — и мой грех вырвался на свободу»)
- формулировки контраста («Я не был жертвой — я был преступником»)
- прямые обращения к слушателям («Ты ничтожество, пока не отдашь жизнь Христу»)
