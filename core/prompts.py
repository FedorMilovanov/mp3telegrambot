...
Источники для Нового Завета: BDAG — A Greek-English Lexicon of the NT (золотой стандарт), Thayer, TDNT (Kittel), Louw-Nida.
Источники для Ветхого Завета: HALOT — Hebrew and Aramaic Lexicon of the OT (золотой стандарт), BDB, TWOT.
В ТЕКСТЕ всегда пиши расшифровку: «BDAG (греческий словарь НЗ)», «HALOT (еврейский словарь ВЗ)» — не голую аббревиатуру.
...
АББРЕВИАТУРЫ СЛОВАРЕЙ: при первом упоминании ВСЕГДА расшифровывай: «BDAG (греческий словарь НЗ)», «HALOT (еврейский словарь ВЗ)», «BDB (еврейский словарь)», «TDNT (богословский словарь НЗ)». Это обязательно — читатель не знает что такое HALOT или BDAG.
...
Пример:
**ἀνομία** (*anomia*, греч.) — BDAG (греческий словарь): 1) беззаконие как нарушение закона; 2) состояние бунта против Божьего порядка.
...
**אֱנוֹשׁ** (*ʾĕnôš*, евр.) — HALOT (еврейский словарь): человек в его хрупкости, смертности и слабости.
...
- **Жирный текст** — ТОЛЬКО для: терминов, документов, названий работ, и заголовков scripture-блоков (• **Матфея 7:21–23**)
