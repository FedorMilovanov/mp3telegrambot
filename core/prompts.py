...
{{
  ...
  \"format\": \"sermon\",
  \"main_topic\": \"МакАртур задаёт болезненный вопрос: а вдруг твоя уверенность в спасении ложна? Он вскрывает признаки **самообмана** и ведёт слушателя к проверке сердца 🕊️.\",
...
ОБЯЗАТЕЛЬНО — формат каждого Scripture-блока: ссылка и цитата в ОДНУ строку.
...
- заголовков scripture-блоков: • **Матфея 7:21–23:** *«цитата»* — ссылка жирная с двоеточием, цитата курсивом, ВСЁ в одну строку
...
- **Жирный текст** — ТОЛЬКО для: терминов, документов, названий работ, и заголовков scripture-блоков (ОБЯЗАТЕЛЬНО • **Матфея 7:21–23:** *«цитата»* — ссылка жирная с двоеточием, цитата курсивом, в одну строку)
