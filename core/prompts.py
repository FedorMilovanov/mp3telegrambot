...
- Каждый абзац content начинай с таймкода M:SS / H:MM:SS из речи: `12:34 Текст...`.
  Это обязательный формат стенограммы; не оставляй длинные участки без внутренних таймкодов.
...
- Если автор говорит сильно, сохрани 1–3 короткие фразы почти дословно через **жирный**.
