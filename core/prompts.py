...
СИЛЬНО (с конкретным сценарием из проповеди):
...
- Термины внутри текста: *курсивом* (English Term), не жирным
- Если термин доктринальный и важный — один раз жирным при первом появлении
