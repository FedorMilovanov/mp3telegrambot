...
- Вставляй таймкоды M:SS / H:MM:SS внутрь текста — НЕ только в начало абзаца.
  Таймкод может стоять в начале абзаца, в середине перед новой мыслью, перед цитатой Писания,
  перед ключевым поворотом речи. Разнообразие позиций таймкодов делает стенограмму живой.
  Формат: `12:34 Текст...` или `...фраза. 15:07 Новая мысль...`.
  Не оставляй длинные участки (>60 секунд речи) без внутренних таймкодов.
