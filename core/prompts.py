...
- не начинай с имени автора и не пиши от третьего лица: «Джон МакАртур анализирует...», «проповедник показывает...»;
...
❌ ПЛОХО: «Джон МакАртур анализирует ключевые тексты...»
...
ПРАВИЛО ИМЁН АВТОРА:
Чередуй полное имя и фамилию для естественного звучания.
- Первое упоминание в каждой section: полное имя (Джон МакАртур).
- Далее в том же section: только фамилия (МакАртур).
- Не повторяй одну форму более 3 раз подряд.
- НЕ добавляй титулы (пастор, доктор, проповедник) если они не звучали в оригинале.
Это универсальное правило для любого автора.
...
Чередуй полное имя и фамилию для естественного звучания.
- Первое упоминание в section: полное имя (Джон МакАртур).
- Далее в том же section: только фамилия (МакАртур).
- Не повторяй одну форму более 3 раз подряд.
- НЕ добавляй титулы (пастор, доктор, проповедник) если они не звучали в оригинале.
Это универсальное правило для любого автора.
...
3. КРИТИЧЕСКИ ВАЖНО — если НЕ уверен что книга переводилась на русский:
   ...
   ❌ ЗАПРЕЩЕНО: - Джон МакАртур, *«Спасение младенцев»* — такого перевода НЕТ
   ✅ ПРАВИЛЬНО: - **Safe in the Arms of God**, Джон МакАртур (John MacArthur)
   ❌ ЗАПРЕЩЕНО: - **Чарльз Сперджен, *«Младенцы во славе»*...**  — жирный у карточки!
   ❌ ЗАПРЕЩЕНО: - Чарльз Сперджен, *«Младенцы во славе»* — выдуманный перевод!
...
❌ ЗАПРЕЩЕНО: - Джон Оуэн, *«Умерщвление греха»* (*John Owen, Of the Mortification of Sin*) — author-first и непроверенное русское название
❌ ЗАПРЕЩЕНО: - **Джон Оуэн, «Умерщвление греха»...** — жирным вся карточка; не делай один источник жирный, остальные нет
...
5. «Карта источников»: title-first. Название источника — жирным, затем русский автор, затем оригинал в скобках.
   ❌ ЗАПРЕЩЕНО: - **Джон Оуэн, «Умерщвление греха»...**
   ❌ ЗАПРЕЩЕНО: - **Чарльз Сперджен, *«Младенцы во славе»*...**
   ✅ ПРАВИЛЬНО:  - **Of the Mortification of Sin**, Джон Оуэн (John Owen)
   Если у книги НЕТ устойчивого русского перевода в registry — НЕ выдумывай его.
   ✅ ПРАВИЛЬНО: - **Safe in the Arms of God**, Джон МакАртур (John MacArthur)
   ❌ ЗАПРЕЩЕНО: - Джон МакАртур, *«Спасение младенцев»*  (если такого русского издания нет)
   ❌ ЗАПРЕЩЕНО: - Чарльз Сперджен, *«Младенцы во славе»* — это выдуманный перевод!
   ✅ ПРАВИЛЬНО: - **Infant Salvation**, Чарльз Сперджен (Charles Spurgeon)
   НЕ ПЕРЕВОДИ английские названия книг, если не знаешь устойчивого признанного русского названия.
   Важно: John MacArthur, *Strange Fire* по-русски — «Чуждый огонь», НЕ «Странный огонь».
