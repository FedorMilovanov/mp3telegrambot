...
❌ ⏱ **17:30** — Когда отношения только начали налаживаться. ← таймкод в начале строки — ЗАПРЕЩЕНО
...
Формат времени: M:SS без ведущего нуля у однозначных минут (5:32, не 05:32).
