...
Пример:
- **Суверенная благодать** (**Sovereign Grace**) — незаслуженная милость Бога, изливающаяся
исключительно по Его изволению. На кону — принцип *только благодатью (Sola Gratia)*.
- **«Лёгкое верие»** (**Easy Believism**) — заблуждение, что для спасения достаточно
интеллектуального согласия без покаяния и послушания.
...
ЗАПРЕЩЕНО:
— начинать пункт с «• **Вопрос**» или «- **Вопрос**»
