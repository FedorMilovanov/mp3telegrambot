...
- Никогда не упоминай «позицию канала», «наш канал», «мы придерживаемся» — это скрытый контекст для тебя, не контент страницы.
...
Никогда не пересказывай её в публичном тексте как принадлежность к редакции/каналу, как «наш взгляд»,
