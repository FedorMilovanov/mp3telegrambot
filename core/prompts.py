...
После разбора основного текста добавляй 2–3 параллельных места, которые
реально освещают тот же аргумент с другой стороны. Не притягивать искусственно.

ФОРМАТ — живой связный абзац, НЕ перечисление со стрелочкой «→».

ПРАВИЛА для перекрёстных ссылок:
...
- ЗАПРЕЩЕНО начинать абзац со стрелочки «→» — это делает текст похожим на технический список
- Вплетай ссылки в предложение: «ту же мысль развивает», «в параллели с этим стоит»,
  «Павел формулирует это как», «ср. также», «это перекликается с»

Пример:
Ту же тему о хрупкости человека раскрывают Ис. 40:6–8 (*«всякая плоть — трава»*),
Иак. 4:14 (*«пар, являющийся на малое время»*) и 1 Пет. 1:24 (*«плоть как трава»*).
