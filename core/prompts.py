...
❌ «МакАртур показывает, что...», «Проповедник объясняет...»
...
- нет ли в main_topic / analysis_summary / argument_arc фраз «Джон МакАртур разрушает», «автор показывает», «проповедник объясняет»;
...
- Нет ли «МакАртур показывает», «проповедник объясняет»?
...
3. Нет ли редакторских фраз «автор показывает/материал рассматривает»?
...
- Нет ли «МакАртур объясняет», «проповедник говорит»? → переписать безлично.
...
Никогда не пересказывай её в публичном тексте как «позицию канала», «наш взгляд»,
...
── ВНУТРЕННИЙ ДОКТРИНАЛЬНЫЙ GUARDRAIL (не публиковать как позицию канала) ─────
...
- Внутренний guardrail: обетования Израилю исполнятся буквально. Церковь ≠ Израиль. Не публикуй это как «позицию канала».
...
✓ Нет ли «Когда Джон МакАртур...», «МакАртур подчеркивает», «проповедник объясняет»? Если есть — перепиши напрямую.
