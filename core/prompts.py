...
- Далее: фамилия (МакАртур) или «пастор МакАртур».
- Не повторяй одну форму более 3 раз подряд.
Это правило для любого проповедника — МакАртур, Вошер, Сперджен и т.д.
...
- Далее в том же section: фамилия (МакАртур), или «пастор МакАртур», «проповедник».
- ЗАПРЕЩЕНО: 5 раз подряд только «МакАртур» без вариации.
Это правило универсально — для ЛЮБОГО проповедника.
