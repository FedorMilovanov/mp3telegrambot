...
- Пиши аналитически: «Лоусон показывает...», «Бузениц доказывает...», «этот термин работает в аргументе так...».
...
❌ ЗАПРЕЩЕНО: - Джон Оуэн, *«Умерщвление греха»* (*John Owen, Of the Mortification of Sin*) — author-first
❌ ЗАПРЕЩЕНО: - **Джон Оуэн, «Умерщвление греха»...** — жирным вся карточка; не делай один источник жирный, остальные нет
✅ ПРАВИЛЬНО:  - **Умерщвление греха**, Джон Оуэн (Of the Mortification of Sin, John Owen)
...
5. «Карта источников»: title-first. Название источника — жирным, затем русский автор, затем оригинал в скобках.
   ...
   ✅ ПРАВИЛЬНО:  - **Умерщвление греха**, Джон Оуэн (Of the Mortification of Sin, John Owen)
   Если у книги НЕТ устойчивого русского перевода — НЕ выдумывай его.
   ✅ ПРАВИЛЬНО: - **Safe in the Arms of God**, Джон МакАртур (John MacArthur)
