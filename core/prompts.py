...
КРИТИЧЕСКИ ВАЖНО — ФОРМАТИРОВАНИЕ ТЕРМИНА С АНГЛИЙСКИМ ЭКВИВАЛЕНТОМ:
Если термин сопровождается английским названием в скобках — включай скобки ВНУТРЬ жирного:
✅ ПРАВИЛЬНО:  **«Полная испорченность» (Total Depravity)** — Божий приговор...
❌ ЗАПРЕЩЕНО:  **«Полная испорченность»** ( **Total Depravity**) — ломает рендер!
❌ ЗАПРЕЩЕНО:  **«Полная испорченность»** (Total Depravity) — скобки вне bold, асимметрично.
Правило: между открывающим ** и закрывающим ** не должно быть других ** маркеров.

Пример:
- **«Оправдание» (Justification)** — Божий судебный акт, в котором грешник объявляется праведным исключительно на основании вменённой праведности Христа.
...
ОБЯЗАТЕЛЬНО: заголовок блока (только сама ссылка) должен быть маркером списка с жирной ссылкой БЕЗ ТОЧКИ на конце: • **Псалом 102:15–16**
Цитаты из Писания в кавычках — курсивом: *«Я никогда не знал вас»*.
...
Элементы:
1. Тире `-` в начале. 2. Ссылка **жирным**, БЕЗ точки. 3. Двоеточие. 4. Цитата в *курсиве*. 5. Диапазоны БЕЗ пробелов.


- content — только Markdown
- **Жирный текст** — ТОЛЬКО для: терминов, документов, названий работ, и заголовков scripture-блоков (ОБЯЗАТЕЛЬНО • **Матфея 7:21–23** без точки в конце)
...
ФОРМАТ — нумерованные пары с **жирным заголовком пары** и текстом ❌/✅:

**I. Краткое название темы контраста: ❌ Название подмены / ✅ Название истины**

❌ **«Лёгкое верие» (Easy Believism).** 1–2 предложения: как выглядит изнутри.

✅ **«Спасение Господством» (Lordship Salvation).** 1–2 предложения: что говорит материал.

**II. Следующий контраст: ❌ Подмена / ✅ Истина**

❌ **«Название».** Описание.

✅ **«Название».** Описание.

Итого 2–3 нумерованных блока. Между блоками — двойная пустая строка.
Нумерация: **I.**, **II.**, **III.** — жирным перед заголовком.

КРИТИЧЕСКИ ВАЖНО — НЕ ПОВТОРЯТЬ:
Если термин «Лёгкое верие», «Спасение Господством» или другой уже разобран
в «Ключевых понятиях» или «Заблуждениях» — выбирай другие контрасты.

ФОРМАТИРОВАНИЕ — вся строка ❌/✅ одним bold-блоком, английский термин ВНУТРИ:
❌ ЗАПРЕЩЕНО: **«Лёгкое верие» (** Easy Believism **)** — ломает рендер!
✅ ПРАВИЛЬНО:  **«Лёгкое верие» (Easy Believism).** — весь заголовок одним bold.
